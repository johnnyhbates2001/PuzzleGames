...
import { ZIP_SIZE, type Difficulty } from '../engine/zip/types'
import { averageTimeMs, getZipProgress, type DifficultyProgress } from '../storage/db'
...
export default function ZipDifficultyPage() {
